...
class MealTableViewController: UITableViewController {
    ...
    private func loadSampleMeals() {
        ...
        guard let meal3 = Meal(name: "Pasta with Meatballs", photo: photo3, rating: 3) else { fatalError("Unable to instantiate meal3")
        }
    ...
    private func saveMeals() {
        ...
        if isSuccessfulSave {
            os_log("Meals succssfully saved.", log: OSLog.default, type: .debug)
        } else {
